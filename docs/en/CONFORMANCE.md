...
- **Impl**: `apps/observers/**`, `security/vault/servicemonitor.yaml`, `apps/ingress-nginx/overlays/prod/servicemonitor.yaml`, `apps/cloudflared/overlays/prod/servicemonitor.yaml`
